    ...
    for rtime in (20000, 40000, 60000, 80000):
        ...
        for dt_val in (0.000012, 0.000024):
            for eta_val in (1.0, 10.0):
                ...
                prefix_str=prefix_str+"_"+arguments["price_update_time"]+"_"+arguments["guardtime"]+"_"+arguments["dt_val"]+"_"+arguments["kvalue_rate"]+"_"+arguments["kvalue_price"]+"_"+arguments["xfabric_eta"]
                final_args=""
