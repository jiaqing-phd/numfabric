...
EXAMPLE_DIRECTORIES = ['stats', 'error-model', 'udp', 'naming', 'tutorial', 'xfabric', 'energy', 'matrix-topology', 'routing', 'udp-client-server', 'tcp', 'wireless', 'realtime', 'ipv6', 'socket']
...
NS3_EXECUTABLE_PATH = ['/cluster/u/csandeep/scratch/knagaraj/post_sig/build/src/emu', '/cluster/u/csandeep/scratch/knagaraj/post_sig/build/src/fd-net-device', '/cluster/u/csandeep/scratch/knagaraj/post_sig/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-redhat-linux/4.4.7', '/cluster/u/csandeep/scratch/knagaraj/post_sig/build']
...
cfg_files = ['/cluster/u/csandeep/scratch/knagaraj/post_sig/build/ns3/config-store-config.h', '/cluster/u/csandeep/scratch/knagaraj/post_sig/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
